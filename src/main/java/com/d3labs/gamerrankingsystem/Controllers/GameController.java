...
/**
 * * A class for handling front-end to the back-end call and the repostiory. Interface with the rest of the program.
 */
@Controller
public class GameController {
     ...
     * 
     * @param playerDto  The data transfer object containing game data. This object is validated before processing.
     ...
     * @return ModelAndView object that redirects to the home page if the game is successfully added, 
