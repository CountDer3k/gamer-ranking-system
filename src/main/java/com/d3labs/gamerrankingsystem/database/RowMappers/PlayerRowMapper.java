...
/**
 * PlayerRowMapper is used for mapping rows of a ResultSet from an SQL database
 * to a PlayerModel object.
 ...
 * extracted values into the field of the PlayerModel object.
 */
...
public class PlayerRowMapper implements RowMapper {
    ...
    public PlayerModel mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        player.setBaseImage(rs.getBytes("player_image"));
        return player;
    }
}
